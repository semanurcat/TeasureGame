...
public class PermanentObstacles {
    ...
    public static class Summer_Tree extends Obstacle {
        ...
        public Summer_Tree() {
            ...
            do {
                ...
                location.setX(location.getX()-size_tree);
    ...
    public static class Summer_Mountain extends Obstacle {
        private int size_mountain = 150;
        public Summer_Mountain() {
            super();
            do {
                location.Location_summer(); // Yeni bir konum atayın.
                location.setX(location.getX()-size_mountain);
            } while (location.isLocationOccupied(location.getX(), location.getY(), size_mountain, size_mountain));
            location.matrix_map(location.getX(), location.getY(), size_mountain, size_mountain, 5);
        }
        // Dağ özellikleri
    ...
    public static class Winter_Mountain extends Obstacle {
        ...
        public Winter_Mountain() {
            ...
            location.matrix_map(location.getX(), location.getY(), size_mountain,size_mountain, 6);
        }
        // Dağ özellikleri
